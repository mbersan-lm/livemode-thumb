  ...
  ({ playerPhoto, photoTransform, matchData, template }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* KV Background - Ao Vivo stadium image covering full canvas */}
        <img 
          src="/kv/kv-ao-vivo.jpg"
          alt="Background Ao Vivo"
        ...
        {homeTeam && awayTeam && (
          <div 
            id="AV_MATCH_ROW"
            className="absolute left-[22px] top-[335px] flex items-center gap-[34px]"
            style={{ 
              zIndex: 20,
              transform: 'none'
            }}
