        ...
        {aoVivoTemplate === 'europaleague' && homeTeam && (
          <img 
            ...
            style={{ 
              ...
              maxWidth: matchData.homeTeamId === 'av5' ? '248px' : matchData.homeTeamId === 'av6' ? '315px' : matchData.homeTeamId === 'av29' ? '400px' : matchData.homeTeamId === 'av21' ? '450px' : matchData.homeTeamId === 'av24' ? '360px' : '500px', 
              maxHeight: matchData.homeTeamId === 'av5' ? '248px' : matchData.homeTeamId === 'av6' ? '315px' : matchData.homeTeamId === 'av29' ? '400px' : matchData.homeTeamId === 'av21' ? '450px' : matchData.homeTeamId === 'av24' ? '360px' : '500px', 
              zIndex: 50 
            }}
          />
        )}
