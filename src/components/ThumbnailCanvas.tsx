              ...
              {matchData.showSmallScore && (
                <div 
                  ...
                  style={{
                    ...
                    lineHeight: '1',
                    marginTop: '4px',
                    transform: template === 'seriea' ? 'translateX(2%)' : template === 'brasileirao' ? 'translateX(-3%)' : template === 'bundesliga' ? 'translateX(-3%)' : template === 'paulistao' ? 'translateX(-3%)' : 'translateX(-15%)',
                  }}
                >
