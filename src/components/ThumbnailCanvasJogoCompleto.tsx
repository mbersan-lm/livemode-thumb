  ...
  ({ playerPhoto, photoTransform, matchData, template }, ref) => {
    ...
    return (
      ...
      >
        ...
        <img 
          src={templates[template].kvJogoCompletoPath} 
        ...
        {homeTeam && awayTeam && (
          <div 
            id="MATCH_ROW_JC"
            className={`absolute -left-[3px] ${template === 'ligue1' || template === 'bundesliga' || template === 'seriea' ? '-top-[40px]' : '-top-[15px]'} flex items-center`}
            style={{ 
              zIndex: 20,
              transform: 'none'
            }}
