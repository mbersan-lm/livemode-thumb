      ...
      >
        ...
        {showThumbPrincipal && useQuadrantGrid && (tpHomeTeamId || tpAwayTeamId) && (() => {
          ...
          return (homeTeam || awayTeam) ? (
            ...
            >
              {homeTeam && <img src={homeTeam.crest_url} alt={homeTeam.name} style={{ height: 173, width: 'auto', position: 'relative', left: 22 }} />}
              {awayTeam && <img src={awayTeam.crest_url} alt={awayTeam.name} style={{ height: 173, width: 'auto', position: 'relative', left: -22 }} />}
            </div>
          ) : null;
        })()}
