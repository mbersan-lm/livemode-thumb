export type TemplateType = 'brasileirao' | 'ligue1' | 'bundesliga' | 'seriea' | 'paulistao' | 'europa-league';
...
export const templates: Record<TemplateType, Template> = {
  ...
  'europa-league': {
    id: 'europa-league',
    name: 'Europa League',
    kvPath: '/kv/kv-europa-league.jpg',
    kvJogoCompletoPath: '/kv/kv-jogo-completo-europa-league.jpg',
    fontFamily: 'Gilroy ExtraBold, sans-serif',
    scoreFontSize: '140px',
    xFontSize: '110px',
    xFontFamily: 'Gilroy Medium, sans-serif',
