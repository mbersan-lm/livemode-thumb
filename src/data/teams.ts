export interface Team {
  ...
  offsetX?: number;    // offset horizontal em px em Melhores Momentos (positivo = afasta do placar)
...
export const teamsBrasileirao: Team[] = [
  ...
  { id: '16', name: 'Santos', slug: 'santos', crest_url: '/crests/santos.png', jcMaxSize: 306, jcOffsetY: 16 },
