...
export const teamsBrasileirao: Team[] = [
  { id: '21', name: 'Athletico-PR', slug: 'athleticopr', crest_url: '' },
  ...
  { id: '22', name: 'Chapecoense', slug: 'chapecoense', crest_url: '' },
  { id: '5', name: 'Corinthians', slug: 'corinthians', crest_url: '/crests/corinthians.png' },
  { id: '23', name: 'Coritiba', slug: 'coritiba', crest_url: '' },
  ...
  { id: '24', name: 'Remo', slug: 'remo', crest_url: '' },
