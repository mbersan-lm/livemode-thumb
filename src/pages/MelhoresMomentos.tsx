...
const MelhoresMomentos = () => {
  ...
  const handleTransformChange = (transform: Partial<PhotoTransform>) => {
        ...
        <div className="p-3 md:p-5 flex-1">
          <Tabs defaultValue="template" className="w-full">
            ...
            <TabsContent value="teams" className="mt-5">
              <TeamControls matchData={state.matchData} onMatchDataChange={handleMatchDataChange} template={state.template} activeCanvas="mm" />
            </TabsContent>
