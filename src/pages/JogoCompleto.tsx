...
const JogoCompleto = () => {
  ...
  const handleJogoCompletoTransformChange = (transform: Partial<PhotoTransform>) => {
      ...
      <div className="w-full md:w-1/2 bg-card border-t md:border-t-0 md:border-l border-border overflow-y-auto flex flex-col flex-1 md:flex-none">
        <div className="p-4 md:p-6 pb-3 md:pb-4 border-b border-border flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight">Jogo Completo</h1>
        ...
        <div className="p-3 md:p-5 flex-1">
          <Tabs defaultValue="template" className="w-full">
            ...
            <TabsContent value="template" className="mt-5">
              <TemplateControls currentTemplate={state.template} onTemplateChange={handleTemplateChange} />
            </TabsContent>
            ...
            <TabsContent value="teams" className="mt-5">
              <TeamControls matchData={state.matchData} onMatchDataChange={handleMatchDataChange} template={state.template} activeCanvas="jc" />
            </TabsContent>

            <TabsContent value="export" className="mt-5">
              <ExportControls canvasRef={canvasRef} canvasRefJogoCompleto={canvasRefJogoCompleto} matchData={state.matchData} />
            </TabsContent>
          </Tabs>
        </div>
      </div>
